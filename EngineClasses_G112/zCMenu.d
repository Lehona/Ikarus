...
class oCViewStatusBar
{
    ...
    var int minLow, maxHigh;         //0x0FC 0x100 zREAL
    var int low, high;               //0x104 0x108 zREAL
    var int previewValue;            //0x10C zREAL
    var int currentValue;            //0x110 zREAL

    var int scale;                   //0x114 float
    var int range_bar;               //0x118 zCView*
    var int preview_bar;             //0x11C zCView*
    var int value_bar;               //0x120 zCView*
    var string texView;              //0x124 zSTRING
    var string texRange;             //0x138 zSTRING
    var string texPreview;           //0x14C zSTRING
    var string texValue;             //0x160 zSTRING
};
