...
class zCTimer {
    var int factorMotion;        //0x00 zREAL        //nicht zu klein machen. Sonst: Freeze bei hoher Framerate!
    var int frameTimeFloat;      //0x04 zREAL [msec] //Zeit der zwischen diesem und dem letzten Frame verstrichen ist
    var int totalTimeFloat;      //0x08 zREAL [msec] //gesamte Zeit
    var int lastTimer;           //0x0C zDWORD
    var int frameTime;           //0x10 zDWORD [msec] //nochmal als Ganzahl
    var int totalTime;           //0x14 zDWORD [msec]
    var int minFrameTime;        //0x18 zDWORD       //antifreeze. Sonst wird die Framezeit auf 0 gerundet und nichts bewegt sich
    var int maxFrameTime;        //0x1C zDWORD       //default: 400
};
...
const int oCLogManager_Ptr = 10625976; //0xA223B8
