...
class zCParser {
    ...
    //zCPar_DataStack           datastack;              //Daten-Stack
        ...
        var int datastack_sptr;                                   //0x1058 int

    var int _self;                                      //0x105C zCPar_Symbol*

    //Ab hier uninteressant, passiert beim Parsen selbst:
    var string fname;                                   //0x1060 zSTRING
    var string mainfile;                                //0x1074 zString
    var int compiled;                                   //0x1088 zBOOL
    var int treesave;                                   //0x108C zBOOL
    var int datsave;                                    //0x1090 zBOOL
    var int parse_changed;                              //0x1094 zBOOL
    var int treeload;                                   //0x1098 zBOOL
    var int mergemode;                                  //0x109C zBOOL
    var int linkingnr;                                  //0x10A0 int
    var int linec;                                      //0x10A4 int
    var int line_start;                                 //0x10A8 int
    var int ext_parse;                                  //0x10AC zBOOL
    var int pc_start;                                   //0x10B0 char*
    var int pc;                                         //0x10B4 char*
    var int oldpc;                                      //0x10B8 char*
    var int pc_stop;                                    //0x10BC char*
    var int oldpc_stop;                                 //0x10C0 char*
    var int params;                                     //0x10C4 zBOOL
    var int in_funcnr;                                  //0x10C8 int
    var int in_classnr;                                 //0x10CC int
    var int stringcount;                                //0x10D0 int
    var int in_func;                                    //0x10D4 zCPar_Symbol*
    var int in_class;                                   //0x10D8 zCPar_Symbol*
    var int error;                                      //0x10DC zBOOL
    var int stop_on_error;                              //0x10E0 zBOOL
    var int errorline;                                  //0x10E4 int
    var int prevword_index[16];                         //0x10E8 char*
    var int prevline_index[16];                         //0x1128 int
    var int prevword_nr;                                //0x1168 int
    var string aword;                                   //0x116C zSTRING
    var int _instance;                                  //0x1180 int
    var int instance_help;                              //0x1184 int
    var int progressBar;                                //0x1188 zCViewProgressBar*
    var int tree;                                       //0x118C zCPar_TreeNode*
    var int treenode;                                   //0x1190 zCPar_TreeNode*
    var int win_code;                                   //0x1194 zCView*
    var int debugmode;                                  //0x1198 zBOOL
    var int curfuncnr;                                  //0x119C int  //Aktuelle Funktion
    var int labelcount;                                 //0x11A0 int
    var int labelpos;                                   //0x11A4 int*

    var int add_funclist;                               //0x11A8 zCList <zSTRING>*

    var string add_filename;                            //0x11AC zSTRING
    var int add_created;                                //0x11C0 zBOOL
};
