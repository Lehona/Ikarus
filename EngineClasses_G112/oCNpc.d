...
//      oCItemContainer inventory2 {
            ...
            var int    inventory2_oCItemContainer__data1;                          // 0x0580
            var int    inventory2_oCItemContainer_viewCat;                         // 0x0584 zCView*
            var int    inventory2_oCItemContainer_viewItem;                        // 0x0588 zCView*
            var int    inventory2_oCItemContainer_viewItemActive;                  // 0x058C zCView*
            var int    inventory2_oCItemContainer_viewItemHightlighted;            // 0x0590 zCView*
            var int    inventory2_oCItemContainer_viewItemActiveHighlighted;       // 0x0594 zCView*
            var int    inventory2_oCItemContainer_viewItemFocus;                   // 0x0598 zCView*
            var int    inventory2_oCItemContainer_viewItemActiveFocus;             // 0x059C zCView*
            var int    inventory2_oCItemContainer_viewItemHightlightedFocus;       // 0x05A0 zCView*
            var int    inventory2_oCItemContainer_viewItemActiveHighlightedFocus;  // 0x05A4 zCView*
            var int    inventory2_oCItemContainer_viewItemInfo;                    // 0x05A8 zCView*
            var int    inventory2_oCItemContainer_viewItemInfoItem;                // 0x05AC zCView*
            var int    inventory2_oCItemContainer_textView;                        // 0x05B0 zCView*
            var int    inventory2_oCItemContainer_viewArrowAtTop;                  // 0x05B4 zCView*
            var int    inventory2_oCItemContainer_viewArrowAtBottom;               // 0x05B8 zCView*
            var int    inventory2_oCItemContainer_rndWorld;                        // 0x05BC zCWorld*
            var int    inventory2_oCItemContainer_posx;                            // 0x05C0 int
            var int    inventory2_oCItemContainer_posy;                            // 0x05C4 int
            var string inventory2_oCItemContainer_textCategoryStatic;              // 0x05C8 zSTRING
            var int    inventory2_oCItemContainer_m_bManipulateItemsDisabled;      // 0x05DC zBOOL
            var int    inventory2_oCItemContainer_m_bCanTransferMoreThanOneItem;   // 0x05E0 zBOOL
            var int    inventory2_oCItemContainer_image_chroma;                    // 0x05E4 zCOLOR
            var int    inventory2_oCItemContainer_blit_chroma;                     // 0x05E8 zCOLOR
//      }
        var int        inventory2_owner;                           // 0x05EC oCNpc*
        var int        inventory2_packAbility;                     // 0x05F0 zBOOL
//      zCListSort<oCItem>[INV_MAX] inventory {
            var int    inventory2_inventory0_Compare;              // 0x05F4 int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory0_data;                 // 0x05F8 oCItem*
            var int    inventory2_inventory0_next;                 // 0x05FC zCListSort<oCItem>*
            var int    inventory2_inventory1_Compare;              // 0x0600 int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory1_data;                 // 0x0604 oCItem*
            var int    inventory2_inventory1_next;                 // 0x0608 zCListSort<oCItem>*
            var int    inventory2_inventory2_Compare;              // 0x060C int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory2_data;                 // 0x0610 oCItem*
            var int    inventory2_inventory2_next;                 // 0x0614 zCListSort<oCItem>*
            var int    inventory2_inventory3_Compare;              // 0x0618 int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory3_data;                 // 0x061C oCItem*
            var int    inventory2_inventory3_next;                 // 0x0620 zCListSort<oCItem>*
            var int    inventory2_inventory4_Compare;              // 0x0624 int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory4_data;                 // 0x0628 oCItem*
            var int    inventory2_inventory4_next;                 // 0x062C zCListSort<oCItem>*
            var int    inventory2_inventory5_Compare;              // 0x0630 int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory5_data;                 // 0x0634 oCItem*
            var int    inventory2_inventory5_next;                 // 0x0638 zCListSort<oCItem>*
            var int    inventory2_inventory6_Compare;              // 0x063C int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory6_data;                 // 0x0640 oCItem*
            var int    inventory2_inventory6_next;                 // 0x0644 zCListSort<oCItem>*
            var int    inventory2_inventory7_Compare;              // 0x0648 int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory7_data;                 // 0x064C oCItem*
            var int    inventory2_inventory7_next;                 // 0x0650 zCListSort<oCItem>*
            var int    inventory2_inventory8_Compare;              // 0x0654 int(_cdecl*)(oCItem*,oCItem*)
            var int    inventory2_inventory8_data;                 // 0x0658 oCItem*
            var int    inventory2_inventory8_next;                 // 0x065C zCListSort<oCItem>*
//      }
        var string     inventory2_packString;                      // 0x0660 zSTRING[INV_MAX]
        ...
        var int        inventory2__offset[9];                      // 0x0714 int[INV_MAX]
        var int        inventory2__itemnr[9];                      // 0x0738 int[INV_MAX]
        var int        inventory2_maxSlots[9];                     // 0x075C int[INV_MAX]
        var int        inventory2_invnr;                           // 0x0780 int
//  }
    var int            trader;                                     // 0x0784 oCItemContainer*
    var int            tradeNpc;                                   // 0x0788 oCNpc*
    var int            rangeToPlayer;                              // 0x078C zREAL
//  zCArray<zTSoundHandle> listOfVoiceHandles {
        var int        listOfVoiceHandles_array;                   // 0x0790 zTSoundHandle*
        var int        listOfVoiceHandles_numAlloc;                // 0x0794 int
        var int        listOfVoiceHandles_numInArray;              // 0x0798 int
//  }
    var int            voiceIndex;                                 // 0x079C int
    var int            bitfield[5];                                // 0x07A0 oCNpc_bitfieldX_Xxx
    var int            instanz;                                    // 0x07B4 int
    var string         mds_name;                                   // 0x07C8 zSTRING
    var string         body_visualName;                            // 0x07DC zSTRING
    var string         head_visualName;                            // 0x07F0 zSTRING
    var int            model_scale[3];                             // 0x07FC VEC3
    var int            model_fatness;                              // 0x0800 zREAL
    var int            namenr;                                     // 0x0804 int
    var int            hpHeal;                                     // 0x0808 zREAL
    var int            manaHeal;                                   // 0x080C zREAL
    var int            swimtime;                                   // 0x0810 zREAL
    var int            divetime;                                   // 0x0814 zREAL
    var int            divectr;                                    // 0x0818 zREAL
    var int            fireVob;                                    // 0x081C zCVob*
    var int            fireDamage;                                 // 0x0820 int
    var int            fireDamageTimer;                            // 0x0824 zREAL
    var int            attitude;                                   // 0x0828 int
    var int            tmp_attitude;                               // 0x082C int
    var int            attTimer;                                   // 0x0830 zREAL
    var int            knowsPlayer;                                // 0x0834 int
    var int            percList[66];                               // 0x0838 TNpcPerc[NPC_PERC_MAX] { int percID; int percFunc }
    var int            percActive;                                 // 0x0940 int
    var int            percActiveTime;                             // 0x0944 zREAL
    var int            percActiveDelta;                            // 0x0948 zREAL
    var int            overrideFallDownHeight;                     // 0x094C zBOOL
    var int            fallDownHeight;                             // 0x0950 zREAL
    var int            fallDownDamage;                             // 0x0954 int
    var int            mag_book;                                   // 0x0958 oCMag_Book*
//  zCList<oCSpell> activeSpells {
        var int        activeSpells_data;                          // 0x095C oCSpell*
        var int        activeSpells_next;                          // 0x0960 int
//  }
//  zCArray<zSTRING> activeOverlays {
        var int        activeOverlays_array;                       // 0x0964 zSTRING*
        var int        activeOverlays_numAlloc;                    // 0x0968 int
        var int        activeOverlays_numInArray;                  // 0x096C int
//  }
    var int            askbox;                                     // 0x0970 oCAskBox*
    var int            askYes;                                     // 0x0974 int
    var int            askNo;                                      // 0x0978 int
    var int            canTalk;                                    // 0x097C zREAL
    var int            talkOther;                                  // 0x0980 oCNpc*
    var int            info;                                       // 0x0984 oCInfo*
    var int            news;                                       // 0x0988 oCNews*
    var int            curMission;                                 // 0x098C oCMission*
//  oCNewsMemory knownNews {
        var int        knownNews_vtbl;                            // 0x0990
//      zCList<oCNews> iknow {
            var int    knownNews_iknow_data;                       // 0x0994 oCNews*
            var int    knownNews_iknow_next;                       // 0x0998 zCList<oCNews>*
//      }
//  }
    var int            carry_vob;                                  // 0x099C zCVob*
    var int            interactMob;                                // 0x09A0 oCMobInter*
    var int            interactItem;                               // 0x09A4 oCItem*
    var int            interactItemCurrentState;                   // 0x09A8 int
    var int            interactItemTargetState;                    // 0x09AC int
    var int            _data1;                                     // 0x09B0
    var int            script_aiprio;                              // 0x09B4 int
    var int            old_script_state;                           // 0x09B8 int
    var int            human_ai;                                   // 0x09BC oCAIHuman*
    var int            anictrl;                                    // 0x09C0 oCAniCtrl_Human*
    var int            route;                                      // 0x09C4 zCRoute*
    var int            damageMul;                                  // 0x09C8 zREAL
    var int            csg;                                        // 0x09CC oCNpcMessage*
    var int            lastLookMsg;                                // 0x09D0 oCNpcMessage*
    var int            lastPointMsg;                               // 0x09D4 oCNpcMessage*
//  zCArray<zCVob*> vobList {
        var int        vobList_array;                              // 0x09D8 zCVob**
        var int        vobList_numAlloc;                           // 0x09DC int
        var int        vobList_numInArray;                         // 0x09D0 int
//  }
    var int            vobcheck_time;                              // 0x09E4 zREAL
    var int            pickvobdelay;                               // 0x09E8 zREAL
    var int            focus_vob;                                  // 0x09EC zCVob*
//  zCArray<TNpcSlot*> invSlot {
        var int        invSlot_array;                              // 0x09F0 TNpcSlot**
        var int        invSlot_numAlloc;                           // 0x09F4 int
        var int        invSlot_numInArray;                         // 0x09F8 int
//  }
//  zCArray<TNpcSlot*> tmpSlotList {
        var int        tmpSlotList_array;                          // 0x09FC TNpcSlot**
        var int        tmpSlotList_numAlloc;                       // 0x0A00 int
        var int        tmpSlotList_numInArray;                     // 0x0A04 int
//  }
    var int            fadeAwayTime;                               // 0x0A08 zREAL
    var int            respawnTime;                                // 0x0A0C zREAL
    var int            selfDist;                                   // 0x0A10 zREAL
    var int            fightRangeBase;                             // 0x0A14 int
    var int            fightRangeFist;                             // 0x0A18 int
    var int            fight_waitTime;                             // 0x0A1C zREAL
    var int            fight_waitForAniEnd;                        // 0x0A20 zTModelAniID
    var int            fight_lastStrafeFrame;                      // 0x0A24 zREAL
    var int            soundType;                                  // 0x0A28 int
    var int            soundVob;                                   // 0x0A2C zCVob*
    var int            soundPosition[3];                           // 0x0A30 zVEC3
    var int            playerGroup;                                // 0x0A3C zCPlayerGroup*
};
const int sizeof_oCNpc = 2624;                                       // 0x0A40
